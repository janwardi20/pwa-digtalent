...
function getSavedTeams() {
  getAll().then(function (data) {
    ...
    <button class="btn-floating halfway-fab waves-effect waves-light red" id="delete" value=" ${data.id} "><iclass="material-icons">delete</i></button>
    </div>
    ...
    for (let button of btn) {
      button.addEventListener("click", function (event) {
        ...
        console.log(id);
        var toastHTML = '<span>Successfully remove the team from
        favorite</span > <button
          onclick="M.Toast.getInstance(this.parentElement).dismiss()" class="btn-flat
